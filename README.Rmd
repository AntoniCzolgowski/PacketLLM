...
PacketLLM integrates OpenAI's powerful GPT-5 language models directly into your RStudio workflow via an interactive RStudio Gadget interface.
...
- The specific OpenAI model (e.g., gpt-5, gpt-5 mini, gpt-5 nano).
- A custom system message to define the AI's role or instructions.
